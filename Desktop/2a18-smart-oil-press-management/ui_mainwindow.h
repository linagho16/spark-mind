...
"QLabel#appTitle,\n"
"QLabel#commandeTitle,\n"
"QLabel#stockTitle { color: #FFFFFF; font-size: 17px; font-weight: 700; }\n"
"QLabel#userLabel,\n"
"QLabel#commandeUserLabel,\n"
"QLabel#stockUserLabel { color: #E6EEF4; font-size: 12px; }\n"
"\n"
...
"QTableWidget {\n"
"    background-color: #ffffff; gridline-color: #E3D8C7; selection-background-color: #FFE9B5; selection-color: #000000; border: 1px solid #E3D8C7;\n"
"}\n"
""
                        "QHeaderView::section {\n"
...
"    font-size: 13px;\n"
"}\n"
"QPushButton#btn_modifier_ext:hover { background-color: #5A7A1E; }\n"
"QPushButton#btn_supprimer_ext {\n"
...
""));
        ...
        spacerBetween = new QSpacerItem(20, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        contentLayout->addItem(spacerBetween);
        ...
        s1 = new QSpacerItem(0, 0, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout->addItem(s1);
        ...
        s2 = new QSpacerItem(0, 0, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout->addItem(s2);
        ...
        stockHost = new QWidget(pageStock);
        stockHost->setObjectName("stockHost");
        stockHostLayout = new QVBoxLayout(stockHost);
        stockHostLayout->setObjectName("stockHostLayout");
        stockHostLayout->setContentsMargins(0, 0, 0, 0);

        stockLayout->addWidget(stockHost);
        ...
        commandeHost = new QWidget(pageCommande);
        commandeHost->setObjectName("commandeHost");
        commandeHostLayout = new QVBoxLayout(commandeHost);
        commandeHostLayout->setObjectName("commandeHostLayout");
        commandeHostLayout->setContentsMargins(0, 0, 0, 0);

        commandeLayout->addWidget(commandeHost);
        ...
        stackedModules->setCurrentIndex(0);

...
private slots:
    ...
    void onExportPDF();
    void onExportExcel();
    void onAfficherStatsOliviers();
    void onAfficherStatsSuperficie();
    void onNouveauAgriculteur();
    void onJoindreFichier();
    void onOuvrirFichier();
...
private:
    ...
    QString cheminFichierJoint(int id) const;
    void    actualiserBoutonsFichier();

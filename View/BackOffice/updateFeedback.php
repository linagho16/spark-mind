...
<head>
    ...
    <title>Update Feedback - Admin Panel</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="form-card">
            ...
            <div class="info-box">
                ...
                <p><strong>Feedback ID:</strong> <code style="font-size: 0.85rem;"><?php echo htmlspecialchars($feedback['id']); ?></code></p>
            </div>

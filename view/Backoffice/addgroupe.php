    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="menu">
                ...
                <a href="/sparkmind_mvc_100percent/controller/donC.php?action=create_don" class="menu-item <?php echo (isset($_GET['action']) && $_GET['action'] == 'create_don') ? 'active' : ''; ?>">
                    <span class="icon">➕</span>
            ...
            <nav class="menu">
                <a href="/sparkmind_mvc_100percent/controller/groupeC.php?action=groupes" class="menu-item <?php echo (isset($_GET['action']) && $_GET['action'] == 'groupes') ? '' : ''; ?>">
                    <span class="icon">👥</span>
                    <span>Tous les groupes</span>
                </a>

                <a href="/sparkmind_mvc_100percent/controller/groupeC.php?action=create_groupe" class="menu-item active">
                    <span class="icon">➕</span>
        ...
        <div class="main">
            ...
            <div class="top-nav">
                ...
                <div class="header-actions">
                    <a href="/sparkmind_mvc_100percent/controller/groupeC.php?action=groupes" class="btn-nav">
                        <span>←</span>
                        <span>Retour</span>
                    </a>
                </div>
            ...
            <div class="admin-main">
                ...
                <div class="form-container">
                    <form method="POST" action="/sparkmind_mvc_100percent/index.php?page=admin_create_groupe">
                        ...
                        <div class="form-actions">
                            ...
                            <a href="/sparkmind_mvc_100percent/index.php?page=admin_groupes" class="btn btn-secondary">
                                <span>✕</span>
                                <span>Annuler</span>
                            </a>
                        </div>

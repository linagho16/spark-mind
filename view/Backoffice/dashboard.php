...
<body>
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="menu">
                <a href="/sparkmind_mvc_100percent/index.php?page=backoffice_aide" class="menu-item active">
            ...
            <nav class="menu">
                <a href="/sparkmind_mvc_100percent/index.php?page=aide_groupes" class="menu-item">
                    <span class="icon">👥</span>
                    <span>Tous les groupes</span>
                </a>

                <a href="/sparkmind_mvc_100percent/index.php?page=aide_create_groupe" class="menu-item">
                    <span class="icon">➕</span>
            ...
            <div class="admin-main">
                ...
                <section class="quick-actions">
                    ...
                    <div class="action-buttons">
                        <a href="/sparkmind_mvc_100percent/controller/donC.php?action=create_don" class="action-btn teal">
                            <span class="action-icon">➕</span>
                            <span>Ajouter un don</span>
                        </a>
                        <a href="/sparkmind_mvc_100percent/controller/donC.php?action=dons" class="action-btn purple">
                            <span class="action-icon">📋</span>
                            <span>Gérer les dons</span>
                        </a>
                        <a href="/sparkmind_mvc_100percent/controller/donC.php?action=statistics" class="action-btn coral">
                            <span class="action-icon">📊</span>

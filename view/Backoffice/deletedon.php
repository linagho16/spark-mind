        ...
        <div class="main">
            ...
            <div class="top-nav">
                ...
                <div class="header-actions">
                    <!-- Back Button -->
                    <a href="/sparkmind_mvc_100percent/controller/donC.php?action=dons" class="btn" style="background: linear-gradient(135deg, #1f8c87, #7eddd5); color: white; text-decoration: none;">
                        <span>←</span>
            ...
            <div class="admin-main">
                ...
                <div class="page-header">
                    ...
                    <p class="page-subtitle">Confirmez la suppression de ce don</p>
                </div>
                ...
                <div class="delete-container">
                    ...
                    <!-- Confirmation Form -->
                    <form method="POST" action="/sparkmind_mvc_100percent/controller/donC.php?action=delete_don&id=<?php echo $don['id']; ?>">

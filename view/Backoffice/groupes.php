...
<body>
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="menu">
                <a href="/aide_solitaire/controller/groupeC.php?action=groupes" class="menu-item active">
                    <span class="icon">👥</span>
            ...
            <div class="admin-main">
                ...
                <header class="top-header">
                    ...
                    <div class="header-right">
                        <a href="/aide_solitaire/controller/groupeC.php?action=create_groupe" class="btn btn-primary">+ Nouveau Groupe</a>
                ...
                <!-- Filters -->
                <form method="GET" action="/aide_solitaire/controller/groupeC.php">
                    ...
                    <div class="filters-section">
                        ...
                        <div class="filters-actions">
                            ...
                            <a href="/aide_solitaire/controller/groupeC.php?action=groupes" class="btn btn-secondary">🔄 Réinitialiser</a>
                        </div>
                    </div>
                </form>
                ...
                <div class="table-container">
                    <?php if (!isset($groupes) || empty($groupes)): ?>
                        <div class="empty-state">
                            ...
                            <a href="/aide_solitaire/controller/groupeC.php?action=create_groupe" class="btn btn-primary" style="margin-top: 1rem;">➕ Créer le premier groupe</a>
                        </div>
                    <?php else: ?>
                        <table>
                            <thead>

            ...
            <div class="admin-main">
                ...
                <div class="details-container">
                    ...
                    <div class="action-buttons">
                        <a href="/aide_solitaire/controller/groupeC.php?action=groupes" class="btn btn-back">
                            ← Retour à la liste
                        </a>
                        <a href="/aide_solitaire/controller/groupeC.php?action=edit_groupe&id=<?php echo $groupe['id']; ?>" class="btn btn-edit">
                            ✏️ Modifier ce groupe
                        </a>
                        <a href="/aide_solitaire/controller/groupeC.php?action=delete_groupe&id=<?php echo $groupe['id']; ?>" class="btn btn-delete"

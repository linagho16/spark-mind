<?php
// view/frontoffice/browse_groupes.php - Browse all groups
session_start();
...
<body>
    ...
    <main class="container">
        ...
        <div class="filters-container">
            ...
            <form method="GET" action="/aide_solitaire/controller/groupeC.php" class="filters-form">
                ...
                <div class="filter-actions">
                    ...
                    <a href="/aide_solitaire/controller/groupeC.php?action=list&context=frontoffice" class="reset-btn">
                        <span>🔄</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-actions">
                                <a href="/aide_solitaire/controller/groupeC.php?action=view&id=<?php echo $groupe['id']; ?>&context=frontoffice" class="btn btn-primary">
                                    <span>🔍</span>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <div style="margin-top: 1.5rem; display: flex; gap: 1rem; justify-content: center;">
                        ...
                        <a href="/aide_solitaire/controller/groupeC.php?action=create&context=frontoffice" class="btn btn-secondary" style="display: inline-flex; width: auto;">
                            <span>➕</span>
        ...
        <section class="quick-actions">
            ...
            <div class="action-buttons">
                <a href="/aide_solitaire/controller/groupeC.php?action=create&context=frontoffice" class="action-btn">
                    <span>👥</span>

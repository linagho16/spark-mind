      ...
      <section class="space-hero">
        <div class="space-content">
          ...
          <div class="card-row">
            ...
            <a class="space-card groups" href="index.php?page=groups_list" id="groupsLink">
              <span>Groupes</span>
              <span class="badge">Rejoindre / créer un groupe</span>
              <span class="bubble">👥</span>
            </a>

            <a class="space-card chat" href="index.php?page=discussions" id="chatLink">
              <span>dons</span>
              <span class="badge">Proposer ce que vous donnez</span>
              <span class="bubble">🤝​</span>
            </a>
          </div>

...
if (isset($_POST['content'])) {
    if (!empty($_POST['content'])) {
        // User update - check user_id
        if ($commentController->updateComment($id, $authorId, $_POST['content'])) {
            header('Location: index.php');
            exit();
        } else {
            $error = 'Error updating comment. You may not have permission to update this comment.';
        }
    } else {
